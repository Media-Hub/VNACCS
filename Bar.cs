namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(Bar), "Bar.ico"), ToolboxItem(true)    
        ,Designer(typeof(DevComponents.DotNetBar.Design.BarDesigner))
    , System.Runtime.InteropServices.ComVisible(false), DefaultEvent("ItemClick")]
        ...
        ICustomSerialization, IRenderingSupport, IAccessibilitySupport, IOwnerLocalize
    {
        ...
        internal void SetDockTabStyle(eDotNetBarStyle style)
        {
            ...
            if(style == eDotNetBarStyle.Metro)
