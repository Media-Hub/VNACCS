...
namespace DevComponents.DotNetBar.Validator
{
    ...
    public class RegularExpressionValidator : ValidatorBase
    {
        ...
        /// </summary>
        [DefaultValue(""), Category("Behavior"), Description("Indicates regular expression used to validate controls value."), Editor("DevComponents.DotNetBar.Design.ValidationExpressionEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
