...
#endif
{
    ...
    public class ElementStyleDisplay
    {
        ...
        public static void PaintText(ElementStyleDisplayInfo e, string text, Font defaultFont, bool useDefaultFont, eTextFormat textFormat)
        {
            ...
            if (textColor.IsEmpty && style.TextShadowColor.IsEmpty)
                textColor = SystemColors.ControlText;
            if (!textColor.IsEmpty)
                TextDrawing.DrawString(e.Graphics, text, font, textColor, textBounds, textFormat);
        ...
        public static void PaintBackground(ElementStyleDisplayInfo e, bool shapeBackground)
        {
            ...
            if (shapeBackground && style.CornerType != eCornerType.Square)
            {
            ...
            else
            {
                ...
                path.AddRectangle(ElementStyleDisplay.GetBackgroundRectangle(style, e.Bounds));
            }
