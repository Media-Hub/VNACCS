...
namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(CrumbBar), "CrumbBar.CrumbBar.ico"), ToolboxItem(true), Designer(typeof(DevComponents.DotNetBar.Design.CrumbBarDesigner))]
    public class CrumbBar : ItemControl
    {
        ...
        /// </summary>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Editor("DevComponents.DotNetBar.Design.CrumbBarItemCollectionEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
#if FRAMEWORK20
        [Browsable(false)]
#else
        [Browsable(true)]
