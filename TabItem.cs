...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [Designer(typeof(DevComponents.DotNetBar.Design.TabItemDesigner)), ToolboxItem(false), ComVisible(false), DesignTimeVisible(false)]
	public class TabItem : Component, IBlock, ISimpleTab
	{
		...
		/// </summary>
		[Browsable(true),DevCoBrowsable(true),DefaultValue(-1),Category("Appearance"),Description("Indicates the tab image index"),Editor("DevComponents.DotNetBar.Design.ImageIndexEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(UITypeEditor)),TypeConverter(typeof(ImageIndexConverter))]
