...
{
	/// <summary>
	/// Generated Class for Table : SLHINHMD.
	/// </summary>
	public partial class SLHINHMD : TableBase
	{
		public SLHINHMD() : base(){}
		...
		{
			return "SELECT " + Fields + " FROM SLHINHMD " + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause) + (string.IsNullOrEmpty(OrderClause) ? string.Empty : " ORDER BY " + OrderClause);
		}
		...
		{
			return "UPDATE SLHINHMD SET " + Fields + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause);
		}
		...
		{
			return clsDAL.DeleteString("SLHINHMD", this.DataManagement) + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause);
		}
