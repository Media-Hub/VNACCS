...
{
	/// <summary>
	/// Generated Class for Table : SHAIQUANIPV4.
	/// </summary>
	public partial class SHAIQUANIPV4 : TableBase
	{
		public SHAIQUANIPV4() : base(){}
		...
		{
			return "SELECT " + Fields + " FROM SHAIQUANIPV4 " + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause) + (string.IsNullOrEmpty(OrderClause) ? string.Empty : " ORDER BY " + OrderClause);
		}
		...
		{
			return "UPDATE SHAIQUANIPV4 SET " + Fields + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause);
		}
		...
		{
			return clsDAL.DeleteString("SHAIQUANIPV4", this.DataManagement) + (string.IsNullOrEmpty(WhereClause) ? string.Empty : " WHERE " + WhereClause);
		}
