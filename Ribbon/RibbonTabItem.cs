...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [ToolboxItem(false), DesignTimeVisible(false), Designer(typeof(DevComponents.DotNetBar.Design.RibbonTabItemDesigner))]
	public class RibbonTabItem:ButtonItem
	{
        ...
        protected override bool IsFadeEnabled
        {
            get
            {
                if ((this.EffectiveStyle == eDotNetBarStyle.Office2010 || this.EffectiveStyle == eDotNetBarStyle.Metro) && WinApi.IsGlassEnabled)
                    return false;
		...
		/// </summary>
        [Editor("DevComponents.DotNetBar.Design.RibbonTabItemGroupTypeEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), Browsable(true), DefaultValue(null), DevCoBrowsable(true), Category("Tab Group"), Description("Indicates the group tab belongs to.")]
        ...
        private void UpdateTabAppearance()
        {
            ...
            else if (this.EffectiveStyle == eDotNetBarStyle.Office2010 || this.EffectiveStyle == eDotNetBarStyle.Metro)
            {
