		...
		public override Rectangle GetImageRectangle(ButtonItem button, ItemPaintArgs pa, CompositeImage image)
		{
			...
			if(image!=null || !string.IsNullOrEmpty(button.Symbol))
			{
                ...
                else
                {
                    ...
                    if ((button.EffectiveStyle == eDotNetBarStyle.Windows7 || button.EffectiveStyle == eDotNetBarStyle.Office2010 || button.EffectiveStyle == eDotNetBarStyle.Metro) && (button is ApplicationButton || button is DevComponents.DotNetBar.Metro.MetroAppButton))
