...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [ToolboxItem(false), Designer(typeof(DevComponents.DotNetBar.Design.RibbonPanelDesigner))]
    public class RibbonPanel : PanelControl, IKeyTipsControl
	{
        ...
        private ElementStyle GetDefaultStyle()
        {
            ...
            if (BarFunctions.IsOffice2007Style(this.EffectiveColorSchemeStyle) || rc != null && BarFunctions.IsOffice2007Style(rc.EffectiveStyle))
            {
                ...
                if (this.EffectiveColorSchemeStyle == eDotNetBarStyle.Metro || rc != null && rc.EffectiveStyle == eDotNetBarStyle.Metro)
                ...
                if (!m_PopupMode)
                {
                    ...
                    m_DefaultStyle.BorderTop = eStyleBorderType.None;
                if (rc != null && (rc.EffectiveStyle == eDotNetBarStyle.Office2010 || rc.EffectiveStyle == eDotNetBarStyle.Metro))
                {
        ...
        private Rectangle GetLayoutRectangle()
        {
            ...
            r.Height -= this.DockPadding.Top + ((this.EffectiveColorSchemeStyle == eDotNetBarStyle.Office2010 || this.EffectiveColorSchemeStyle == eDotNetBarStyle.Metro) && this.DockPadding.Bottom == 3 ? 2 : this.DockPadding.Bottom);

            if (this.EffectiveColorSchemeStyle == eDotNetBarStyle.Metro && this.DockPadding.All == 0)
            {
                r.Y += 3;
                r.Height -= 6;
            }
