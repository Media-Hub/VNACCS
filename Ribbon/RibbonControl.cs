...
namespace DevComponents.DotNetBar
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(RibbonControl), "Ribbon.RibbonControl.ico"), ToolboxItem(true), Designer(typeof(DevComponents.DotNetBar.Design.RibbonControlDesigner)), System.Runtime.InteropServices.ComVisible(false)]
    public class RibbonControl : System.Windows.Forms.ContainerControl
    {
        ...
        protected override void WndProc(ref Message m)
        {
            if (m.Msg == (int)WinApi.WindowsMessages.WM_NCHITTEST)
            {
                ...
                if ((this.EffectiveStyle == eDotNetBarStyle.Office2010 || this.EffectiveStyle == eDotNetBarStyle.Metro) && (p.X < 28 && this.RightToLeft == RightToLeft.No || p.X > this.Width - 28 && this.RightToLeft == RightToLeft.Yes) && p.Y < 28)
                {
                    m.Result = new IntPtr((int)WinApi.WindowHitTestRegions.TransparentOrCovered);
                    return;
                }
        ...
        protected virtual Region GetControlRegion()
        {
            if (this.Parent is RibbonForm && ((Form)this.Parent).WindowState == FormWindowState.Maximized)
                return null;
            eDotNetBarStyle effectiveStyle = this.EffectiveStyle;
            if (effectiveStyle == eDotNetBarStyle.Metro) return null;
