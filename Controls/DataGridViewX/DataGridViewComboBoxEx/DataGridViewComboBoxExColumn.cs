...
namespace DevComponents.DotNetBar.Controls
{
    ...
    public class DataGridViewComboBoxExColumn : DataGridViewTextBoxColumn, IDataGridViewColumn
    {
        ...
        {
            get { return (_ComboBoxEx.Col1Width); }
            set { _ComboBoxEx.Col1Width = value; }
        }
       
        public int Col2Width
        {
            get { return (_ComboBoxEx.Col2Width); }
            set { _ComboBoxEx.Col2Width = value; }
        }

        public int Col3Width
        {
            get { return (_ComboBoxEx.Col3Width); }
            set { _ComboBoxEx.Col3Width = value; }
        }
        ...
        {
            get { return (_ComboBoxEx.MoRongKhiForcus); }
            set { _ComboBoxEx.MoRongKhiForcus = value; }
        }
        #endregion      

        //TuyenHM
        #region DropDownColumnsHeaders
        public string DropDownColumnsHeaders
        {
            get { return (_ComboBoxEx.DropDownColumnsHeaders); }
            set { _ComboBoxEx.DropDownColumnsHeaders = value; }
        }
        #endregion
        ...
        {
            get { return (_ComboBoxEx.DropDownColumns); }
            set { _ComboBoxEx.DropDownColumns = value; }
        }
        ...
        public override object Clone()
        {
            ...
            if (cb != null)
            {
                ...
                cb.DropDownColumns = DropDownColumns;
