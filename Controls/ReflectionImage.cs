...
namespace DevComponents.DotNetBar.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(ReflectionImage), "Controls.ReflectionImage.ico"), ToolboxItem(true), Designer(typeof(DevComponents.DotNetBar.Design.ReflectionImageDesigner))]
