...
{
    [ToolboxBitmap(typeof(TextBoxX), "Controls.TextBoxX.ico"), ToolboxItem(true), 
    Designer(typeof(DevComponents.DotNetBar.Design.TextBoxXDesigner))]
...
, IInputButtonControl
#endif
    {
        ...
        public void StyleManagerStyleChanged(eDotNetBarStyle newStyle)
        {
            ...
            if (newStyle == eDotNetBarStyle.Metro || StyleManager.PreviousStyle == eStyle.Metro && newStyle != eDotNetBarStyle.Metro)
