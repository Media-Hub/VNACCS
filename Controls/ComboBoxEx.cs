...
namespace DevComponents.DotNetBar.Controls
{
    ...
    ToolboxItem(true),
    //Designer(typeof(DevComponents.DotNetBar.Design.ComboBoxExDesigner, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
   Designer(typeof(DevComponents.DotNetBar.Design.ComboBoxExDesigner))
    ]
    public class ComboBoxEx : System.Windows.Forms.ComboBox, ICommandSource
    {
        ...
        public int Col1Width
        {
            get
            {
                if (this._MultiColumnDisplay != null)
                {
                    ...
                    {
                        return this._MultiColumnDisplay.Columns[0].Width.Absolute;
                    }
                    else
                    {
                        return _Col1Width;
            ...
            set
            {
                if (this._MultiColumnDisplay != null)
                {
                    if (this._MultiColumnDisplay.Columns.Count > 0)
                    {
                        this._MultiColumnDisplay.Columns[0].Width.Absolute = value;
                    }
                    else
                    {
                        _Col1Width = value;
        ...
        public int Col2Width
        {
            get
            {
                if (this._MultiColumnDisplay != null)
                {
                    ...
                    {
                        return this._MultiColumnDisplay.Columns[1].Width.Absolute;
                    }
                    else
                    {
                        return _Col2Width;
            ...
            set
            {
                if (this._MultiColumnDisplay != null)
                {
                    if (this._MultiColumnDisplay.Columns.Count > 1)
                    {
                        this._MultiColumnDisplay.Columns[1].Width.Absolute = value;
                    }
                    else
                    {
                        _Col2Width = value;
        ...
        public int Col3Width
        {
            get
            {
                if (this._MultiColumnDisplay != null)
                {
                    ...
                    {
                        return this._MultiColumnDisplay.Columns[2].Width.Absolute;
                    }
                    else
                    {
                        return _Col3Width;
            ...
            set
            {
                if (this._MultiColumnDisplay != null)
                {
                    if (this._MultiColumnDisplay.Columns.Count > 2)
                    {
                        this._MultiColumnDisplay.Columns[2].Width.Absolute = value;
                    }
                    else
                    {
                        _Col3Width = value;
        ...
        public int Col4Width
        {
            get
            {
                if (this._MultiColumnDisplay != null)
                {
                    if (this._MultiColumnDisplay.Columns.Count > 3)
                    {
                        return this._MultiColumnDisplay.Columns[3].Width.Absolute;
                    }
                    else
                    {
                        return _Col4Width;
            ...
            set
            {
                if (this._MultiColumnDisplay != null)
                {
                    if (this._MultiColumnDisplay.Columns.Count > 3)
                    {
                        this._MultiColumnDisplay.Columns[3].Width.Absolute = value;
                    }
                    else
                    {
                        _Col4Width = value;
        ...
        {
            Debug.WriteLine(e.KeyCode.ToString() + " ComboBoxEx ComboBoxEx_KeyDown");
        }
        ...
        void ComboBoxEx_Enter(object sender, EventArgs e)
        {
            if (_MoRongKhiForcus)
            {
                ...
                //_MultiColumnDisplay.Focus();
                //this.TreeKeyDown(sender, new KeyEventArgs(Keys.Down));
            }
        }
        #endregion
        ...
        //TuyenHM
        #region MoRongKhiForcus
        private bool _MoRongKhiForcus = false;
        public bool MoRongKhiForcus
        {
            get { return (_MoRongKhiForcus); }
            set { _MoRongKhiForcus = value; }
        }
        #endregion
        ...
        private bool m_UseCustomBackColor = true;
        /// <summary>
        ...
        {
            Debug.WriteLine(keyData.ToString() + "comboboxEx");
        ...
        [System.ComponentModel.Editor("DevComponents.DotNetBar.Design.ComboItemsEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor)), Localizable(true)]
        ...
        [Editor(typeof(DevComponents.DotNetBar.Design.DataMembersSelector), typeof(System.Drawing.Design.UITypeEditor))]
        ...
        public AdvTree.AdvTree _MultiColumnDisplay = null;
        /// <summary>
        ...
        [Editor("DevComponents.DotNetBar.Design.ColumnNamesEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(System.Drawing.Design.UITypeEditor))]
        [TypeConverter("DevComponents.DotNetBar.Design.ColumnNamesConverter, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf")]
        ...
        private AdvTree.AdvTree CreateMultiColumnDisplayControl()
        {
            ...
            ////TuyenHM
            ////chỉnh hiển thị đường kẻ lưới và màu, tuy nhiên phối màu chưa đẹp
            //tree.GridLinesColor = Color.Magenta;
        ...
        public bool PopupCloseButtonVisible
        {
            ...
            get {
                if (_PopupController != null)
                {
                    return _PopupController.CloseButtonVisible;
                }
                else
                {
                    return _PopupCloseButtonVisible;
                }
                }
            //set
            //{
            ...
            set {
                if (_PopupController != null)
                {
                    _PopupController.CloseButtonVisible = value;
                }
                else
                {
                    _PopupCloseButtonVisible = value;
