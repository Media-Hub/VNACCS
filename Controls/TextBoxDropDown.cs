...
namespace DevComponents.DotNetBar.Controls
{
    ...
    /// </summary>
    [ToolboxBitmap(typeof(TextBoxDropDown), "Controls.TextBoxDropDown.ico"), ToolboxItem(true), DefaultProperty("Text"), DefaultBindingProperty("Text"), DefaultEvent("TextChanged"), 
    Designer(typeof(DevComponents.DotNetBar.Design.TextBoxDropDownDesigner))]
