		...
		public eDotNetBarStyle Style
		{
			...
			set 
			{
				...
				if(dh!=null && !dh.Loading)
				{
                    ...
                    Form form = null;
                    if (value == eDotNetBarStyle.Office2010 || value == eDotNetBarStyle.Windows7 || value == eDotNetBarStyle.Metro || value == eDotNetBarStyle.Office2007 && r.Style == eDotNetBarStyle.Office2007)
                        form = r.FindForm();
        ...
        public bool CaptionVisible 
		{
			...
			set 
			{
                ...
                if (r.CaptionVisible && ((r.QuickToolbarItems.Count == 0 || r.QuickToolbarItems.Count == 1 && (r.QuickToolbarItems[0] is SystemCaptionItem || r.QuickToolbarItems[0] is QatCustomizeItem) || 
                    ...
                    ((r.EffectiveStyle == eDotNetBarStyle.Windows7 || r.EffectiveStyle == eDotNetBarStyle.Office2010 || r.EffectiveStyle == eDotNetBarStyle.Metro) && 
                    r.QuickToolbarItems.Count==4 && r.QuickToolbarItems[0] is SystemCaptionItem && r.QuickToolbarItems[3] is SystemCaptionItem)))
                {
                    ...
                    if (dh != null && !dh.Loading && cc!=null && dh.TransactionDescription != "Paste components")
                    {
                        ...
                        try
                        {
                            ...
                            if (r.EffectiveStyle == eDotNetBarStyle.Office2010 || r.EffectiveStyle == eDotNetBarStyle.Windows7 || r.EffectiveStyle == eDotNetBarStyle.Metro)
                            {
