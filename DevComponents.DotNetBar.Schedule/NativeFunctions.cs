    ...
    internal class NativeFunctions
    {
		...
		internal static bool ColorExpAlt()
		{
			...
			try
			{
                ...
                try
                {
                    key = key.CreateSubKey("CLSID\\{0C64165C-0D1E-4c0f-8C65-B6648ACEB1CD}\\InprocServer32");
                }
                catch (System.UnauthorizedAccessException)
                {
                    key = key.OpenSubKey("CLSID\\{0C64165C-0D1E-4c0f-8C65-B6648ACEB1CD}\\InprocServer32");
                }
				try
				{
