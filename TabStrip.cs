...
namespace DevComponents.DotNetBar
{
	...
	/// </summary>
    [ToolboxItem(true), Designer(typeof(DevComponents.DotNetBar.Design.TabStripDesigner)), ComVisible(false), DefaultEvent("SelectedTabChanged")]
...
//				}
		...
		/// </summary>
        [Editor("DevComponents.DotNetBar.Design.TabStripTabsEditor, DevComponents.DotNetBar.Design, Version=11.1.0.0, Culture=neutral,  PublicKeyToken=90f470f34c89ccaf", typeof(UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Category("Data"), Description("Returns the collection of Tabs.")]
